...
library(SKAT)
Close_SSD()
File.Bed <- "./obesity/obesitycohort.bed"
File.Bim <- "./obesity/obesitycohort.bim"
...
out.skato.emmax <- SKAT.SSD.All(SSD.INFOX50k, objx, kernel = "linear",
...
write.table(output.df, file = "./obesity/resultsinorder1/50k-SKATSSD_ALL-BN-Linear-Burden-40-bestguess-0-100")
...
fn<-"./obesity/resultsinorder1/50k-SKATSSD_ALL-BN-Linear-SKATO-40-bestguess-0-100";
